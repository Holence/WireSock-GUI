...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionCheck_Status = QAction(MainWindow)
        self.actionCheck_Status.setObjectName(u"actionCheck_Status")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionCheck_Status.setText(QCoreApplication.translate("MainWindow", u"Check Status", None))
#if QT_CONFIG(shortcut)
        self.actionCheck_Status.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+R", None))
